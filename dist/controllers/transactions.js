...
exports.getRecurring = exports.createBatchTransactions = exports.getTransactions = void 0;
...
const getTransactions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (search)
        transactions = transactions.filter((item) => item.name.toLowerCase().includes(search));
...
const createBatchTransactions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    req.body.forEach((obj) => transactions_1.createBatchTransactionsSchema.parse(obj));
